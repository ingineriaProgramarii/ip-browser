...
import browserAcces.PluginBase;
...
public class AudioPlayer extends PluginBase
{
	...
	public void loadContent(URL url)
	{
		...
		try
		{
			...
			Long duration = null;
			AudioInputStream currentDecoded = AudioSystem.getAudioInputStream(
			...
			synchronized (lock)
			{
				// Parametro que ativa ou nALo o fade de acordo com o tamanho do
				// A!udio
				...
				while (true)
				{
					...
					if (secondsFade > 0
							&& duration > paramFade
							&& !fezFadeOut
							&& line.getMicrosecondPosition() >= duration
									- ((this.secondsFade + 1) * 1000000))
					{
